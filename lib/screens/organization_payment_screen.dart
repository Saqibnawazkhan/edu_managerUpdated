...
class OrganizationPaymentScreen extends StatefulWidget {
  const OrganizationPaymentScreen({super.key});

  @override
  State<OrganizationPaymentScreen> createState() => _OrganizationPaymentScreenState();
}

class _OrganizationPaymentScreenState extends State<OrganizationPaymentScreen>
  ...
  final List<OrganizationPackage> _packages = [
    const OrganizationPackage(
      name: 'Monthly',
      price: 30000,
      duration: '10 Devices',
...
Please verify and provide admin login credentials.
''';
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'All packages include 10 devices & Admin Account',
                                style: TextStyle(
                                  fontSize: 13,
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        'PKR ${_formatPrice(package.price)}',
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                          color: isSelected ? Colors.white : package.color,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text(
                  'Your organization payment request has been sent via WhatsApp. We will verify your payment and send you admin login credentials soon.',
